...
GlobalCompany.version = "1.0.1.0";
GlobalCompany.versionDate = "05.08.2019"; -- Release Date ??
GlobalCompany.currentVersionId = 1010; -- Mod Manager ID. (Version number without periods.)
